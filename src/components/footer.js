...
function footer() {
  return (
    <div>
      <footer className='p-7 flex gap-28'>
        <div className='text-[#a1a1a1] font-sans space-y-1.5'>
        ...
        <div className='text-[#a1a1a1] font-sans space-y-1.5'>
          ...
          <p className='hover:text-white hover:underline'>Developer</p>
        ...
        <div className='flex-1 ml-[500px] my-6'>
          <button className=' p-3 rounded-full bg-[#292929] mx-4 hover:bg-gray-500'>
            <svg
              width='15px'
              height='15px'
              viewBox='0 0 24 24'
          ...
          <button className=' p-3 rounded-full bg-[#292929] hover:bg-gray-500'>
            <svg
              width='15px'
              height='15px'
              viewBox='0 -2 20 20'
