...
function BtnPlayInPlaylist() {
  return (
    <div>
      <button className='rounded-full bg-[#1ed760] p-3 hover:scale-105'>
        <svg
          width='40px'
          height='40px'
          viewBox='-3 0 28 28'
        ...
        >
          ...
          <g id='SVGRepo_iconCarrier'>
            ...
            >
              ...
              <g
                id='Icon-Set-Filled'
                transform='translate(-417.000000, -571.000000)'
                fill='#000000'
              >
                {' '}
                <path
...
export default BtnPlayInPlaylist